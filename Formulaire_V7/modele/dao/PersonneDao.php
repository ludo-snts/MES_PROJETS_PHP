...
// require_once '../entite/Personne.php';
// require_once '../entite/Genre.php';
...
class PersonneDao {
    ...
    public function modifier($personne){
        ...
        $requete = $this->Connexion->prepare($sql);
        $requete->bindParam(':id', $personne->getId());
        $requete->bindParam(':prenom', $personne->getPrenom());
        $requete->bindParam(':nom', $personne->getNom());
        $requete->bindParam(':mail', $personne->getMail());
        $requete->bindParam(':age', $personne->getAge());
        $requete->bindParam(':username', $personne->getUsername());
        $requete->bindParam(':password', $personne->getPassword());

        $hgenre = $personne->getGenre();
        $requete->bindParam(':idgenre', $hgenre->getId());

        $hrole = $personne->getRole();
        $requete->bindParam(':idrole', $hrole->getId());
