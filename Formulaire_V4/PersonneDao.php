...
class PersonneDao {
    ...
    public function creer($personne) {
        $sql = "INSERT INTO " . self::TABLE . " (prenom,nom,mail,age,idgenre, idrole) VALUES (:prenom,:nom,:mail,:age,:idgenre, :idrole)";
    ...
    // }
    public function modifier($personne){
        $sql = "UPDATE " . self::TABLE . " SET prenom = :prenom, nom = :nom, mail = :mail, age = :age, idgenre = :idgenre, idrole = :idrole WHERE id = :id";
        $requete = $this->Connexion->prepare($sql);
