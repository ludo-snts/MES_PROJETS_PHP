                    ...
                    <tbody class="list-container-tab-body">
                        ...
                        <tr>
                            ...
                            foreach ($tab_personnes as $personne) { ?>
                                ...
                                <td>
                                    <?php 
                                    if ($personne->getGenre()->getLibelle() == "ho") echo "homme"; 
                                    if ($personne->getGenre()->getLibelle() == "fe") echo "femme"; 
                                    if ($personne->getGenre()->getLibelle() == "au") echo "autre";  
                                    ?>
                                </td>
                                <td>
